  ...
  return (
    <>
      {open && <section className="chat-panel" aria-label="Honeywell Products Assistant">
        <header><span><Sparkles size={18} /> Honeywell Products Assistant<small>Live AI Assistant</small></span><button onClick={() => setOpen(false)} aria-label="Close assistant"><X size={19} /></button></header>
