      ...
      >
        ...
        <div style={{
          ...
          <div>
            ...
            <h2 style={{ fontSize: '18px', fontWeight: 800, margin: '4px 0 0 0', lineHeight: 1.2 }}>
              {supplier.name}
            </h2>
            <p style={{ fontSize: '11.5px', color: '#a7f3d0', margin: '2px 0 0 0' }}>
        ...
        >
          ...
          {/* Quick Metrics Row */}
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px', borderBottom: '1px solid #f1f5f9', paddingBottom: '14px' }}>
            <div style={{ backgroundColor: '#f8fafc', padding: '10px 12px', borderRadius: '10px', textAlign: 'center', border: '1px solid #f1f5f9' }}>
              ...
              <strong style={{ fontSize: '14px', color: '#0f172a', fontWeight: 800, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '4px', marginTop: '2px' }}>
            ...
            <div style={{ backgroundColor: '#f8fafc', padding: '10px 12px', borderRadius: '10px', textAlign: 'center', border: '1px solid #f1f5f9' }}>
              ...
              <strong style={{ fontSize: '14px', color: '#0f172a', fontWeight: 800, display: 'block', marginTop: '2px' }}>
                {supplier.activePo ?? 0}
              </strong>
            </div>
            <div style={{ backgroundColor: '#f8fafc', padding: '10px 12px', borderRadius: '10px', textAlign: 'center', border: '1px solid #f1f5f9' }}>
